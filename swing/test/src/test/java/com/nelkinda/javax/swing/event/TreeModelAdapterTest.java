...
public class TreeModelAdapterTest {
    @Test
    public void providesDefaultsForAllMethods() {
        final TreeModelListener treeModelListener = new TreeModelAdapter() {
        };
        treeModelListener.treeNodesChanged(null);
        treeModelListener.treeNodesInserted(null);
        treeModelListener.treeNodesRemoved(null);
