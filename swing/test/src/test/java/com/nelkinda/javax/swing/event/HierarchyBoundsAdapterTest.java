...
public class HierarchyBoundsAdapterTest {
    ...
    public void providesDefaultsForAllMethods() {
        final HierarchyBoundsListener hierarchyBoundsListener = new HierarchyBoundsAdapter() {
        };
        hierarchyBoundsListener.ancestorMoved(null);
        hierarchyBoundsListener.ancestorResized(null);
    }
}
