...
public class InternalFrameAdapterTest {
    ...
    public void providesDefaultsForAllMethods() {
        ...
        internalFrameListener.internalFrameClosed(null);
        internalFrameListener.internalFrameClosing(null);
        internalFrameListener.internalFrameDeactivated(null);
        internalFrameListener.internalFrameDeiconified(null);
        internalFrameListener.internalFrameIconified(null);
        internalFrameListener.internalFrameOpened(null);
    }
}
