...
/**
 * An abstract adapter for receiving {@link ComponentEvent}s.
 * The methods in this adapter are empty.
 * This adapter exists as convenience for creating {@link ComponentListener} objects.
 *
...
public interface ComponentAdapter extends ComponentListener {
    ...
    @Override
    default void componentResized(final ComponentEvent e) {
    }
