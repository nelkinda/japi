...
/**
 * An abstract adapter for receiving {@link HierarchyEvent}s.
 * The methods in this adapter are empty.
 * This adapter exists as convenience for creating {@link HierarchyBoundsListener} objects.
 *
...
public interface HierarchyBoundsAdapter extends HierarchyBoundsListener {
    @Override
    default void ancestorMoved(final HierarchyEvent e) {
    }

    @Override
    default void ancestorResized(final HierarchyEvent e) {
    }
}
