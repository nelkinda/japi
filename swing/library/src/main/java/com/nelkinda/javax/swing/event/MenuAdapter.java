...
/**
 * An abstract adapter for receiving {@link MenuEvent}s.
 * The methods in this adapter are empty.
 * This adapter exists as convenience for creating {@link MenuListener} objects.
 *
 * @author <a href="mailto:Christian.Hujer@nelkinda.com">Christian Hujer</a>, Nelkinda Software Craft Pvt Ltd
 * @version 0.0.3
 * @since 0.0.3
 */
public interface MenuAdapter extends MenuListener {
    @Override
    default void menuSelected(final MenuEvent e) {
    }
