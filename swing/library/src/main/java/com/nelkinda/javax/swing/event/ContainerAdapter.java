...
/**
 * An abstract adapter for receiving {@link ContainerEvent}s.
 * The methods in this adapter are empty.
 * This adapter exists as convenience for creating {@link ContainerListener} objects.
 *
...
public interface ContainerAdapter extends ContainerListener {
    @Override
    default void componentAdded(final ContainerEvent e) {
    }

    @Override
    default void componentRemoved(final ContainerEvent e) {
    }
}
